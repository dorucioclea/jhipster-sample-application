...
import jhipster.app.test.service.JHipsterUaaServerKafkaConsumer;
...
public class JHipsterUaaServerKafkaResourceIT {
    ...
    @Autowired
    private JHipsterUaaServerKafkaProducer producer;

    @Autowired
    private JHipsterUaaServerKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JHipsterUaaServerKafkaResource kafkaResource = new JHipsterUaaServerKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/j-hipster-uaa-server-kafka/publish?message=test"))
