package jhipster.app.test.repository;

import jhipster.app.test.JHipsterUaaServerApp;
import jhipster.app.test.config.Constants;
import jhipster.app.test.config.audit.AuditEventConverter;
...
import static jhipster.app.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
